    ...
    <el-card>
      ...
      <el-form :inline="true" :model="queryForm" class="search-form">
        <el-form-item label="请假类型">
          <el-select v-model="queryForm.leaveType" placeholder="请选择类型" clearable style="width: 150px;">
      ...
      <el-table :data="tableData" style="width: 100%" v-loading="loading" stripe>
        ...
        <el-table-column prop="leaveType" label="请假类型" width="100" align="center">
          <template #default="scope">
            <el-tag>{{ getLeaveTypeName(scope.row.leaveType) }}</el-tag>
          </template>
        </el-table-column>
...
import { getLeavePage, addLeave, approveLeave } from '@/api/leave'
...
const getLeaveTypeName = (type) => leaveTypeMap[type] || '未知'
